...
namespace Alura.Loja.Testes.ConsoleApp.Migrations
{
    ...
    [Migration("20180724182657_Promocao")]
    partial class Promocao
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Alura.Loja.Testes.ConsoleApp.Comprar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Alura.Loja.Testes.ConsoleApp.Promocao", b =>
                {
                    ...
                    b.Property<DateTime>("DataInicia");
            ...
            modelBuilder.Entity("Alura.Loja.Testes.ConsoleApp.Comprar", b =>
                {
                    b.HasOne("Alura.Loja.Testes.ConsoleApp.Produto", "Pruduto")
                        .WithMany()
